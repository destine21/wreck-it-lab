                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-body m-3 pb-0">
                                                    ...
                                                    - การทำ feature Upload file ให้ปลอดภัยจำเป็นที่จะต้องตรวจสอบสิ่งที่ผู้ใช้อัพมาให้ดี ต้องทำการตรวจสอบชนิดของไฟล์ หากเป็นไฟล์รูปให้ใช้ ฟังก์ชัน เพื่อตรวจสอบว่าเป็นรูปจริงไหม เช่น getimagesize() ใน PHP และต้องทำการตรวจสอบนามสกุลไฟล์ ตรวจสอบขนาดไฟล์ ควรที่จะเปลี่ยนชื่อหลังจากการอัพโหลดแล้ว และอาจเพิ่ม security header เช่น "Content-Disposition: Attachment" และ "X-Content-Type-Options: nosniff" ให้ response จาก server เป็น static file เป็นต้น
                                                </div>
