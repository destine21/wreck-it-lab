...
--
-- Host: localhost
-- Generation Time: Dec 01, 2018 at 07:17 AM
...
('root', '[{\"db\":\"scoring\",\"table\":\"score\"},{\"db\":\"wreck-it-lab\",\"table\":\"users\"},{\"db\":\"fakebook\",\"table\":\"posts\"}]');
...
('root', '2018-12-01 06:15:02', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":241}');
...
CREATE DATABASE IF NOT EXISTS `scoring` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `scoring`;
...
INSERT INTO `score` (`chapter`, `score`, `state`) VALUES
(1, 10, 0),
(2, 15, 0),
(3, 30, 0),
(4, 15, 0),
